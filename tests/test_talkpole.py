# import pytest
# import logging
# from app.models import TalkpoleCBI, TalkpoleCNN, TalkpoleLSTM, TalkpoleModel
...
# @pytest.fixture()
# def cbi(logger):
#   return TalkpoleCBI(logger,'/app/models/files/cbi.keras','/app/models/tokenizers/tokenizer2.json')

# @pytest.fixture()
# def cnn(logger):
#   return TalkpoleCNN(logger,'/app/models/files/cnn.h5','/app/models/tokenizers/tokenizer1.json')

# @pytest.fixture()
# def lstm(logger):
#   return TalkpoleLSTM(logger,'/app/models/files/lstm.keras','/app/models/tokenizers/tokenizer2.json')


# # TalkpoleModel can't be instanciated
# def test_non_inst():
#   logr = logging.getLogger('tests_logger')
#   talkpoleModel = TalkpoleModel(logr,'vulnerability','../app/models/files/lstm.keras','../app/models/tokenizers/tokenizer2.json')
  
#   assert talkpoleModel is None
